...
export type IotCapabilityIconKey = 'plug' | 'bellRing' | 'cloudCog' | 'layers';

export const iotCapabilities: {
  title: string;
  desc: string;
  tags: string[];
  icon: IotCapabilityIconKey;
}[] = [
  {
    title: '百万级设备接入',
    desc: '分布式架构支撑百万设备同时在线，高吞吐、低时延，轻松应对规模增长',
    tags: ['高并发', '弹性扩展', '分布式'],
    icon: 'layers',
  },
  {
    title: '100+协议支持',
    desc: '内置丰富协议驱动，覆盖工业、能源、楼宇等主流场景，即插即用，快速完成设备上云',
    tags: ['Modbus', 'MQTT', 'OPC UA', 'HTTP'],
    icon: 'plug',
  },
  {
    title: '智能告警联动',
    desc: '多维度告警规则灵活配置，异常自动触发联动动作，实现从发现到处置的完整闭环',
    tags: ['实时告警', '规则联动', '消息推送'],
    icon: 'bellRing',
  },
  {
    title: '云边协同',
    desc: '云端统一管理、边缘就近计算，数据双向同步，保障弱网环境下业务连续运行',
    tags: ['边缘计算', '云端同步', '离线续传'],
    icon: 'cloudCog',
  },
];

export const iotStats = [
  { value: '100+', label: '协议支持' },
  { value: '1,000,000+', label: '设备接入' },
  { value: '99.99%', label: '平台可用性' },
  { value: '毫秒级', label: '数据处理能力' },
] as const;

export const iotIllustrationHotspots = [
  {
    id: 'device',
    label: '设备管理',
    top: '14%',
    left: '4%',
    items: ['设备接入', '设备监控', '设备运维', '设备分组'],
  },
  {
    id: 'data',
    label: '数据处理',
...
export type VideoCapabilityIconKey =
  | 'cctv'
  | 'monitorPlay'
  | 'film'
  | 'archive'
...
export const videoCapabilities: {
  title: string;
  desc: string;
  icon: VideoCapabilityIconKey;
}[] = [
  {
    title: '多源接入',
    desc: '支持海康、大华、宇视等多品牌设备接入，兼容 GB/T 28181、ONVIF 等主流协议，统一平台管理',
    icon: 'cctv',
  },
  {
    title: '实时监控',
    desc: '支持多画面电视墙轮巡与分组管理，云台控制与实时预览，全面掌握现场动态',
    icon: 'monitorPlay',
  },
  {
    title: '视频回放',
    desc: '高效录像回放，支持倍速播放与事件标记，快速定位关键视频片段',
    icon: 'film',
  },
  {
    title: '归档留存',
    desc: '灵活配置存储策略，支持定时归档与长期留存，满足合规与证据保全需求',
    icon: 'archive',
  },
  {
    title: '智能检索',
    desc: '自然语言描述即可检索目标画面，AI 理解语义，秒级定位关键视频',
    icon: 'sparkles',
  },
  {
    title: '以图搜图',
    desc: '上传目标图片，AI 相似度匹配，快速找到相似场景与目标视频',
    icon: 'scanSearch',
  },
];
